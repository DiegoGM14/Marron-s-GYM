...
<title>Dieta Saludable - Marron's Gym</title>
...
<div class="nav-container">
    ...
    <ul class="nav-menu">
        ...
        <li class="nav-item"><a href="dieta.php" class="nav-link active">Dieta Saludable</a></li>
...
<div class="container">
<h1 class="dashboard-title">Tu Plan de Dieta</h1>
<p>Seguimiento de alimentación saludable:</p>
...
<div class="dashboard-grid">
    <div class="dashboard-card">
        ...
        <div class="card-content">
            <h3>Desayuno</h3>
            <p>Avena con fruta y nueces</p>
        </div>
    </div>
    <div class="dashboard-card">
        <div class="card-icon"><i class="fas fa-carrot"></i></div>
        <div class="card-content">
            <h3>Almuerzo</h3>
            <p>Pechuga de pollo con ensalada</p>
        </div>
    </div>
    <div class="dashboard-card">
        ...
        <div class="card-content">
            <h3>Cena</h3>
            <p>Salmón al horno con vegetales</p>
        </div>
    </div>
</div>
